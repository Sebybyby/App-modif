# -*- coding: utf-8 -*-
"""
Choix du nombre de cartes pour Soft Pos — boutons radio uniquement.
"""
...
RB_STYLE = (
    "QRadioButton { color:#FFFFFF; background:%s; font-size:15px; padding:6px; spacing:10px; }"
...
class SP_PopUpChoice(Interface):
    ...
    def _build_header(self):
        ...
        # Bouton par-dessus la ligne 0, aligné à gauche
    ...
    def _build_center(self):
        """Boutons radio cartes + bouton rond Valider."""
        container = QWidget()
