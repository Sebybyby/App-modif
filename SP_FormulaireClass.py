# -*- coding: utf-8 -*-
"""
Formulaire pour Soft Pos — version standalone, indépendante de FormulaireClass.py.
Retourne au menu Soft Pos (enum=9).
"""
from PySide6.QtWidgets import (
    QLabel, QPushButton, QLineEdit, QFrame, QHBoxLayout
)
...
class SP_Formulaire(Interface):
    def __init__(self):
        Interface.__init__(self)
        self.etat = False
        self.windowPlace = []
        self.enum = InterfaceAffiche(10)
        self.fichier = Fichier.Instance()

        self.setStyleSheet(f"background:{BG};")

        # Grille : 8 lignes x 9 colonnes
    ...
    def _build_header(self):
        ...
        self.titre = QLabel("Formulaire — Soft Pos")
