# -*- coding: utf-8 -*-
"""
Config Son Lecteur pour Soft Pos — version standalone, indépendante de FichierConfigLecteur.py.
...
class SP_FichierReader(fftsignallecteur, Interface):
    def __init__(self):
    ...
    def NouvellePageLect(self):
        ...
        # Titre centré
        self.ti = QLabel("Config Son Lecteur — Soft Pos")
